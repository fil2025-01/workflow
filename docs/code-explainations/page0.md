# Code Explanations Table of Contents

1. [Upload Handler Syntax](./page1.md)
1. [Handling the Continuation Recording Button](./page2.md)
1. [Axum Extractors Explained](./page3.md)
